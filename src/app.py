...
class MyFrame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        # label that serves as the drag-and-drop area and image display.
        ...
        # Register the label as a drop target and bind event
        self.drop_label.drop_target_register(DND_FILES)
        self.drop_label.dnd_bind('<<Drop>>', self.drop)

        self.prediction_label = ctk.CTkLabel(self, text="", anchor="center")
    ...
    def drop(self, event):
        # event.data may contain multiple file paths
    ...
    def process_image(self, file_path):
        ...
        try:
            ...
            self.prediction_label.configure(text=f"Predicted Model: {predicted_model}")
...
class App(TkinterDnD.Tk):
    ...
    def open_file(self):
        # Opens a file dialog for image selection and sends the image to el Frame
